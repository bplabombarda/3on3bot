...
def parse_game(game, hashtags):
    ...
    # Check END 3RD
    # =====================================================================
    if game["bs"] == "LIVE" and game["ts"] == "END 3rd":

        tweet_game(api, away_team_ht, away_team_score, home_team_ht, home_team_score)

    # =====================================================================
    # Check OT
    # =====================================================================
    elif game["bs"] == "LIVE" and game["ts"].split(" ")[1] == "OT":

        tweet_game(api, away_team_ht, away_team_score, home_team_ht, home_team_score)


def tweet_game(api, away_team_ht, away_team_score, home_team_ht, home_team_score):

    if home_team_score == away_team_score:
        score = home_team_score
        status = (
            away_team_ht + " @ " + home_team_ht + " tied at " + score + " in #3on3OT"
        )
        # print(status)
